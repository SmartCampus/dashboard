    ...
    */
    ...
    $("#checkbox_all").click(function(){
        ...
        $('.my_checkbox').each(function(){
            ...
            if(checked){
                this.checked = true;
                if(!already_checked)load_and_launch_urljson("../common-data/sensors.json",put_sensors,kind,"img/"+kind+".png");
            }
            else{
                this.checked = false;
                clear_icons();
    ...
    $('.my_checkbox').change(function(){
        ...
        if($(this).prop("checked")){
            load_and_launch_urljson("../common-data/sensors.json",put_sensors,kind,"img/"+kind+".png");
        }
        else{
            load_and_launch_urljson("../common-data/sensors.json",unput_sensors,kind,"img/"+kind+".png");
        }
