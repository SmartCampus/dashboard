        ...
        for(i=0;i<list_alertes.length;i++){
            ...
            function insert_icon_group(){
                ...
                if(existing_circle.get(0) == undefined){
                    ...
                    img.attr('title',title+'<br/>capteur '+kind+' | batiment '+bat+' | salle '+salle+temp);
                }
            }
            ...
            function insert_icon(){
                ...
                if(existing_img.get(0) == undefined){
                     node_to_insert.append("image")
                            ...
                            .attr('x', x)
                            .attr('y', y)
                            .attr('title','<img alt="img-capteur" src="./img/'+kind+'.png" style="width:20px"/>capteur '+kind+' | batiment '+bat+' | salle '+salle+temp)
